...
$TITLE OPTION 0:  SCENARIO with ASF & High Income
$title 'text'
...
*DYEC makes income elasticity higher or lower (Ex.: 1.5 = 50% higher)
   DYEC(C,U)          =  1.0 ;
*Increase the DYE for CommPig & ModPig to 2.3 & reduce the DYE for TradPig to 0.6
...
*$ontext
*Source: derived from data of DAH, Dec. 2019
*NNQue2019: assume 80-90% of total ASF-Induced Losses mainly from TradPig and
* only 10-20% from CommPig. ModPig is not innfected.
...
*NNQue2019 added Pig Trade Ban (from MRD to SE)
*$offtext
